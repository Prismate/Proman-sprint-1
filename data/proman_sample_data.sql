...
ALTER TABLE app_user ALTER COLUMN user_id SET DEFAULT nextval('app_user_user_id_seq');

ALTER TABLE cards DROP CONSTRAINT fk_cards_board_id;
ALTER TABLE cards ADD CONSTRAINT fk_cards_board_id FOREIGN KEY (board_id) REFERENCES boards(id) ON DELETE CASCADE;